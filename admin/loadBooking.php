...
if (!empty($_POST["ref"])) {
    ...
    WHERE `registered_guest`.`ref_number`='" . $_POST["ref"] . "'");
    ...
    if ($rs->num_rows > 0) {
        $obj->status = 1;
        $obj->content = '
            <table class="ui definition table d-none" id="refTable">
                <thead>
                    <tr>
                        <th></th>
                        <th>Email</th>
            ...
            $obj->content .= '
                ...
                <tr class="d-none" id="refTr' . $id . '">
                    ...
                    <td colspan="4">
                        ...
                        <div class="mt-2 fw-bold">NIC : <span class="text-primary fw-normal">' . $row["nic"] . '</span></div>
